...
THEN
  ...
  IF :NEW.custkey IS NOT NULL THEN
    ...
    IF :NEW.operationid != 208 THEN
      ...
      IF :NEW.operationid IN (19, 100, 213, 223, 80, 82, 228) -- Zveli valis gadatana!!!
      THEN
        ...
        END IF;
      ELSIF :NEW.operationid IN (73, 129, 229, 600, 601, 602, 603, 131, 132) -- MXOLOD mimdinare valis cvlileba!!!
      THEN
        ------------------------------------------------------------------------
